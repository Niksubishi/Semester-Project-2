import{g as H,a as $,b as W}from"./read-MB-BRnXe.js";import{A as _,h as U}from"./404-Dy6-cS9p.js";import{c as F}from"./cards-Bn-sZUx-.js";async function R(s,t){var o,u;const g=localStorage.getItem("token"),r=await fetch(_.SINGLE(s),{method:"PUT",headers:U(g),body:JSON.stringify({avatar:{url:t.avatar.url,alt:t.avatar.alt},bio:t.bio})});if(!r.ok){const m=await r.json();throw new Error(((u=(o=m.errors)==null?void 0:o[0])==null?void 0:u.message)||"Failed to update profile")}return r.json()}function q(s){var t;return`
